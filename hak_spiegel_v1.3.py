# to do: Knoppen maken aan het rechter menu
# 
# kiezen of het oorspronkelijke object moet blijven bestaan.
...
class MESH_OT_spiegel(bpy.types.Operator):
    ...
    knop_vlakken: bpy.props.BoolProperty(
        name = "binnenvakken wissen",
        default = False)
    ...
    def execute(self,context):
        knop=self.knop
        knop_vlakken = self.knop_vlakken
